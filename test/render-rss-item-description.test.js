...
const { RSS_ITEM_DESCRIPTION_RENDERER_KEY } = require('../lib/constants');

const basicInput = require('./stubs/render/rss-item-description-basic--input');
const basicOutput = htmlBeautify(fs.readFileSync(path.resolve(__dirname, './stubs/render/rss-item-description-basic--output.xml'), 'utf8'));

const newTagInput = require('./stubs/render/rss-item-description-new-tag--input');
const newTagOutput = htmlBeautify(fs.readFileSync(path.resolve(__dirname, './stubs/render/rss-item-description-new-tag--output.xml'), 'utf8'));

const updateTagInput = require('./stubs/render/rss-item-description-update-tag--input');
const updateTagOutput = htmlBeautify(fs.readFileSync(path.resolve(__dirname, './stubs/render/rss-item-description-update-tag--output.xml'), 'utf8'));
